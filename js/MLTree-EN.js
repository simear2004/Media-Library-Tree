...
function showSearchContextMenu(x, y) {
	...
	menu.AppendMenuItem(hasSel  ? 0 : MF_GRAYED, 1, 'Cut');
	menu.AppendMenuItem(hasSel  ? 0 : MF_GRAYED, 2, 'Copy');
	menu.AppendMenuItem(hasClip ? 0 : MF_GRAYED, 3, 'Paste');
	menu.AppendMenuSeparator();
	menu.AppendMenuItem(hasText ? 0 : MF_GRAYED, 4, 'Select All');
	menu.AppendMenuItem(hasText ? 0 : MF_GRAYED, 5, 'Clear');
